...
public class BraceChecker {
    ...
    // 1. while loop through the string loop while there are still balanced together braces
    // 2. when there are (inside the loop) remove all instances of balanced braces that are together with ""
    // 3. when done looping check the length of the remaining string
    // 4. return true if the length is zero
