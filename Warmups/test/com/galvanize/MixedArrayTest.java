...
class MixedArrayTest {
    ...
    public void test_2() {
        ...
        assertEquals(22, mixedSum.sum3(Arrays.asList(9, 3, "7", "3")));
    }
    ...
    public void test_3() {
        ...
        assertEquals(42, mixedSum.sum3(Arrays.asList("5", "0", 9, 3, 2, 1, "9", 6, 7)));
    }
    ...
    public void test_4() {
        ...
        assertEquals(41, mixedSum.sum3(Arrays.asList("3", 6, 6, 0, "5", 8, 5, "6", 2, "0")));
    }
    ...
    public void test_5() {
        ...
        assertEquals(45, mixedSum.sum3(Arrays.asList("1", "5", "8", 8, 9, 9, 2, "3")));
    }
    ...
    public void test_7() {
        ...
        assertEquals(61, mixedSum.sum3(Arrays.asList(8, 0, 0, 8, 5, 7, 2, 3, 7, 8, 6, 7)));
    }
}